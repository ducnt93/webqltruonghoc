<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="phanlop.ascx.cs" Inherits="QLTHPT.UcControl.AdminControls.NhaTruong.phanlop" %>
<style type="text/css">
...
<div>
    ...
    <asp:Panel ID="Panel2" runat="server">
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style22">
                        <asp:Label ID="txtMaPL" runat="server"></asp:Label>
                    </td>
        ...
        <br />
        <asp:GridView ID="gvPhanlop" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="STT" ForeColor="#333333" GridLines="None" OnRowDeleting="gvPhanlop_RowDeleting" OnRowUpdating="gvPhanlop_RowUpdating" Width="662px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="STT" HeaderText="Mã Phân Lớp" Visible="False" />
