...
namespace QLTHPT1.BusinessObjects
{
	public class THOIKHOABIEU
	{
		...
		public THOIKHOABIEU(int matkb, string tenthu, int malop, string tiet1, string tiet2, string tiet3, string tiet4, string tiet5, DateTime tungay, DateTime denngay, int mahk)
		{
			this.MaTKB = matkb;
			this.TenThu = tenthu;
			this.MaLop = malop;
